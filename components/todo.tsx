'use client';
import { GetDataType } from '@/actions/todo.actions';
import { TodoWithRemarksType, remarks } from '@/db/schema';
import { ChangeEvent, FC, useState } from 'react';

type Flatten<Type> = Type extends Array<infer Item> ? Item : Type;

interface Props {
  todo: Flatten<GetDataType>;
